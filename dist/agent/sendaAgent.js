...
async function extraerDatosFactura(mensaje) {
...
async function generarFacturaReal(datos) {
...
export async function procesarMensajeCliente(mensaje) {
    const datos = await extraerDatosFactura(mensaje);
    if (!datos.rfc)
        return "❌ Error: Necesito un RFC válido.";
    try {
